...
?>
    <div class="border border-secondary-300 p-4 ">
        ...
        <form action="index.php?url=supplier/remove/<?php echo $user['id']; ?>" method="post" class='form'>
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" name="teléfono" class='form-control' value="<?php echo $user['teléfono']; ?>" readonly>
            </div>
